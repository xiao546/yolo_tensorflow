...
class Solver(object):
    ...
    def __init__(self, net, data):
        ...
        self.initial_learning_rate = cfg.LEARNING_RATE #学习速率LEARNING_RATE = 0.0001
        self.decay_steps = cfg.DECAY_STEPS #速率延迟步数DECAY_STEPS = 30000
        self.decay_rate = cfg.DECAY_RATE #延迟率DECAY_RATE = 0.1
        self.staircase = cfg.STAIRCASE #？？？STAIRCASE = True
        self.summary_iter = cfg.SUMMARY_ITER #SUMMARY_ITER = 10
        ...
        # 指数平均数指标，Some training algorithms, such as GradientDescent and Momentum
        # often benefit from maintaining a moving average of variables during optimization.
        # Using the moving averages for evaluations often improve results significantly.
        # An exponential moving average (EMA) is a type of moving average that is similar to
        # a simple moving average, except that more weight is given to the latest data
        ...
        # 如果tensorflow版本未升级，会报错，需要改为tf.initialize_all_variables()
        # self.sess.run(tf.initialize_all_variables())#初始化
